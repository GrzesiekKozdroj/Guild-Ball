...
const alchIco = "./icons/Alchemists.png", 
      ...
      brewIco = "./icons/Brewers.png", 
      butcIco = "./icons/Butchers.png", 
      cookIco = "./icons/Cooks.png", 
      engiIco = "./icons/Engineers.png", 
      falcIco = "./icons/Falconers.png", 
      farmIco = "./icons/Farmers.png", 
      fishIco = "./icons/Fishermen.png", 
      huntIco = "./icons/Hunters.png", 
      masoIco = "./icons/Masons.png", 
      mineIco = "./icons/Miners.png", 
      mortIco = "./icons/Morticians.png", 
      naviIco = "./icons/Navigators.png", 
      soltIco = "./icons/Solthecian.png", 
      ratcIco = "./icons/Ratcatchers.png", 
      unioIco = "./icons/Union.png";

const alchFam = "./icons/Alch.png",
      blacFam = "./icons/Blac.png",
      brewFam = "./icons/Brew.png",
      butcFam = "./icons/Butc.png",
      cookFam = "./icons/Cook.png",
      engiFam = "./icons/Engi.png",
      falcFam = "./icons/Falc.png",
      farmFam = "./icons/Farm.png",
      fishFam = "./icons/Fish.png",
      huntFam = "./icons/Hunt.png",
      masoFam = "./icons/Maso.png",
      maneIco = "./icons/Mine.png",
      mOrtIco = "./icons/Mort.png",
      navIIco = "./icons/Navi.png",
      soltFam = "./icons/Solt.png",
      ratcFam = "./icons/Ratc.png",
      unioFam = "./icons/Unio.png";

// const  alchFam = new Image(); alchFam.src = "./icons/Alch.png";
// const  blacFam = new Image(); blacFam.src = "./icons/Blac.png";
// const  brewFam = new Image(); brewFam.src = "./icons/Brew.png";
// const  butcFam = new Image(); butcFam.src = "./icons/Butc.png";
// const  cookFam = new Image(); cookFam.src = "./icons/Cook.png";
// const  engiFam = new Image(); engiFam.src = "./icons/Engi.png";
// const  falcFam = new Image(); falcFam.src = "./icons/Falc.png";
// const  farmFam = new Image(); farmFam.src = "./icons/Farm.png";
// const  fishFam = new Image(); fishFam.src = "./icons/Fish.png";
// const  huntFam = new Image(); huntFam.src = "./icons/Hunt.png";
// const  masoFam = new Image(); masoFam.src = "./icons/Maso.png";
// const  maneIco = new Image(); maneIco.src = "./icons/Mine.png";
// const  mOrtIco = new Image(); mOrtIco.src = "./icons/Mort.png";
// const  navIIco = new Image(); navIIco.src = "./icons/Navi.png";
// const  soltFam = new Image(); soltFam.src = "./icons/Solt.png";
// const  ratcFam = new Image(); ratcFam.src = "./icons/Ratc.png";
// const  unioFam = new Image(); unioFam.src = "./icons/Unio.png";
